...
NOTICE: DynaDoc is not yet ready for production, but is in Beta. Every piece of this project is still under heavy development. It is certainly a good idea to begin developing with DynaDoc so you can get familiar with the features and tool. You should not use this library for production purposes until version 1.0.0 is released. I am looking for feedback and ideas so please help me make this library better by creating issues and pull requests! :) Planned production release date is: 12/18/2015 
