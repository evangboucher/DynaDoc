...
/*
We should accept an object that has the table names and another param with
arrays that have the objects to write. We could then generate the payload with
the given details and send it off to dynamoDB to write.
@TODO Implement this.
*/
