    ...
    for (var tableName in arrayOfTableNames) {
        ...
        if (putItemsObject) {
            ...
            if (!tableRequestArray) {
                ...
                //throw Util.createError('smartBatchWrite Error. Table Name did not exist in the putItems Object.');
                /*
        ...
        */
        if (deleteItemObject) {
            ...
            if (!deleteItemArray) {
                //This tableName does not exist in the object.
                //throw Util.createError('smartBatchWrite Error. Table Name did not exist in the deleteItems Object.');
                /*
                For now lets not do anything. Maybe we should have a strict
                mode to throw the above error. This is not really an error
                though.
