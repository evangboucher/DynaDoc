...
DynaDoc.prototype.setSettings = function setSettings(userSettings) {
    ...
    */
    addOptionsToPayload(this.settings, userSettings);
...
**/
function addOptionsToPayload(payload, options) {
    /*
...
DynaDoc.prototype.putItem = function putItem(item, options) {
    ...
    */
    ...
    if (options) {
        //Add the options.
        addOptionsToPayload(payload, options);
    }
...
DynaDoc.prototype.batchWrite = function batchWrite(params, options) {
    ...
    if (options) {
        //Add the options.
        addOptionsToPayload(params, options);
    }
