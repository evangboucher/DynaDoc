...
**/
CreateIndexHelper.addGlobalIndex = function addGlobalIndex(payload, indexObject, dyModel, readCapacity, writeCapacity, indexName, updateIndex) {
    var indexPayload = {};
    //Lets add this global index.
    var hashModelObject = searchModelForKey(indexObject[INDEX_CREATION_HASH_KEY], dyModel);
    //This will generate the basic elemtns of the payload.
    generateMainIndexKeys(indexPayload, indexObject, readCapacity, writeCapacity, indexName);
...
CreateIndexHelper.addLocalIndex = function addLocalIndex(payload, indexObject, dyModel, indexName) {
    ...
    */
    generateMainIndexKeys(indexPayload, indexObject, undefined, undefined, indexName);
...
CreateIndexHelper.updateGlobalIndex = function updateGlobalIndex(payload, indexName, readCapacity, writeCapacity) {
    var updatePayload = {};
    updatePayload[UPDATE_INDEX_UPDATE_KEY] = {"IndexName":indexName};
