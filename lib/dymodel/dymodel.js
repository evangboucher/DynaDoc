...
const KEY_OPTIONS_RANGE_KEY = "RangeKey";
...
**/
DyModel.prototype.ensureGlobalIndex = function ensureGlobalIndex(indexName, hashKey, options) {
    ...
    if (options && options.hasOwnProperty(KEY_OPTIONS_RANGE_KEY)) {
        rangeKey = options[KEY_OPTIONS_RANGE_KEY];
        delete options[KEY_OPTIONS_RANGE_KEY];
        console.log('ensureGlobalIndex. The range key is: ' + rangeKey);
    }
...
**/
DyModel.prototype.ensureLocalIndex = function ensureLocalIndex(indexName, rangeKey, options) {
