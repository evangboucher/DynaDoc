...
const KEY_RANGE_KEY = "RangeKey";
const KEY_ACTION_TYPE = "Action";
constants.KEY_RANGE_VALUE = KEY_RANGE_VALUE;
constants.KEY_RANGE_KEY = KEY_RANGE_KEY;
constants.KEY_ACTION_TYPE = KEY_ACTION_TYPE;


const KEY_BATCH_PUT_ITEMS = "PutItemsObject";
const KEY_BATCH_DELETE_ITEMS = "DeleteItemsObject";

constants.KEY_BATCH_PUT_ITEMS = KEY_BATCH_PUT_ITEMS;
constants.KEY_BATCH_DELETE_ITEMS = KEY_BATCH_DELETE_ITEMS;


const OPTION_USE_TLS1 = "UseTLSV1";
constants.OPTION_USE_TLS1 = OPTION_USE_TLS1;

//Not using const yet to better support older versions. Option Prefix.
const OPTION_TABLE_PREFIX = "TablePrefix";
constants.OPTION_TABLE_PREFIX = OPTION_TABLE_PREFIX;
